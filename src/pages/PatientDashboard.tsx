...
import { Heart, Calendar, User, Clock, MapPin, FileText, CheckCircle, XCircle, Filter, CreditCard, Plus } from "lucide-react";
        ...
        if (appts && Array.isArray(appts)) {
          appts.forEach((apt: any) => {
            transformedAppointments.push({
              ...
              payment_required: apt.status === "confirmed",
        ...
        if (ops && Array.isArray(ops)) {
          ops.forEach((op: any) => {
            transformedAppointments.push({
              ...
              date: op.date || op.operation_date || "",
              time: op.time_slot || "",
              type: "Operation",
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          {/* Welcome Section */}
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-foreground mb-2">Patient Dashboard</h1>
            <p className="text-muted-foreground">Manage your appointments and operations</p>
          </div>
                ...
                >
                  ...
                  <div className="mt-4 pt-4 border-t border-border flex flex-wrap items-center justify-between gap-4">
                    ...
                    {appointment.status === "confirmed" && (
                      <Link to={`/payment?appointment_id=${appointment.id}`}>
